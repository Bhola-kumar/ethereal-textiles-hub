                            ...
                            {pincode && (
                              <div className="mb-2">
                                {delivery.isDeliverable ? (
                                  <span className="text-xs text-green-600 flex items-center gap-1 bg-green-50 dark:bg-green-950/30 px-2 py-1 rounded w-fit">
                                    <Truck className="h-3 w-3" />
                                    Delivery by {delivery.estimatedDate} ({delivery.daysRange})
                                  </span>
                                ) : (
                                  <span className="text-xs text-destructive flex items-center gap-1 bg-destructive/10 px-2 py-1 rounded w-fit">
