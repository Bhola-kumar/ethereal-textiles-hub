  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold">My Promo Codes</h1>
      ...
      <Alert>
        ...
        <AlertDescription>
          Promo codes you create will only apply to your products. Share these codes with your customers to offer discounts.
        </AlertDescription>
      </Alert>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-sm font-medium">My Promo Codes</CardTitle>
              ...
              {(!promoCodes || promoCodes.length === 0) && (
                <TableRow>
                  <TableCell colSpan={6} className="text-center py-8 text-muted-foreground">
                    No promo codes yet. Create your first one to offer discounts!
                  </TableCell>
                </TableRow>
              )}
            </TableBody>
